...
|---|---|---|---|
| `konzepte/Methodik-und-Tagesstruktur.md` | Methoden-Masterdokument (Lernphilosophie, Tagesstruktur, UE-Aufbau, Querschnittsthemen) | - | - |
...
Was bedeutet TRF?;Tun bis Retten bis Frei machen;LF-I-Basiskompetenzen;Kommentar S. 9
```
