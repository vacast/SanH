...
|---|---|
| **Teilnehmerorientierung** | Erfahrungs-Hook zu Beginn („Habt ihr schon einmal jemanden mit Atemnot erlebt?"), Tempo wird an Vorwissen aus LF I angepasst |
| **Handlungsorientierung** | Jede UE mind. eine Praxis-Phase mit Atem-Beobachtung am Partner, Schauspielpatienten ab UE 2 |
| **Lernfeldorientierung** | Schnittstellen zu LF III (HLW) und LF IV (Brustkorbverletzungen) explizit aufzeigen; ABCDE aus LF I wird in UE 2 wieder aufgegriffen |
| **Praxisorientierung** | Mind. 50 % Realzeit mit Übungen, Stoppuhr für Atemkontrolle (<10 s) und für Notruf, Schauspielpatienten |
...
|---|---|---|
| Anatomie-Plakat Atemwege (obere/untere Atemwege, Kehlkopf, Lungenbläschen) | 1 | UE 1 Theorie |
| Demo-Atemwegsmodell (Phantom mit austauschbaren Atemwegen) | 1 | UE 1, UE 2 |
| Übungsphantom Reanimationspuppe (mit Beatmungsmöglichkeit) | 1 | UE 2, UE 5 |
| Stethoskop (Demo, 1/TN zum Üben) | 8 | UE 2 Pulsmessung-Demo |
| Stoppuhr / Smartphone-Timer | TN-eigene + 1 Großdisplay | UE 2, UE 5 Atemkontrolle |
| Sauerstoffflasche (5 L, gefüllt, Übungsflasche) + Flowmeter + Maske | 1 | UE 3 |
| Defekte/unbenutzte O2-Flasche zur Sicherheits-Demo (Restdruck sichtbar) | 1 | UE 3 |
| O2-Berechnungs-Aufgabenblatt (DIN A4, 1/TN) | 8 | UE 3 |
| Kohlendioxid-Rückatmungstüte (Plastiktüte, klein) | 2 | UE 5 Hyperventilations-Demo |
| Eisbeutel / kalte Kompressen | 4 | UE 5 Insektenstich-Demo |
| Moulage-Set (Rötung, Insektenstich, Zyanose-Lippenstift) | 1 Set | UE 4, UE 5 |
| Schauspielpatienten (Rekrutierung mind. 2 Personen) | 2 | UE 4, UE 5, UE 6 |
| Aspiration-Trainings-Set (Backenzahn-Prothese + kleine Spielzeugteile + Brei) | 1 | UE 4 |
| Lippenbremse-Anleitung (DIN A5, 1/TN) | 8 | UE 5 |
| Lippenbremse-Übungs-Strohhalm | 8 | UE 5 |
...
| Element | Umsetzung in LF II |
|---|---|
| **Punkte** | 1 Punkt pro richtiger Anwendung im Übungssetting, max. 1 Punkt pro TN/UE |
| **Badges** | 6 Badges (1 pro UE), s. Tabelle unten |
| **Streak** | 6/6 UE anwesend + bestanden = SanH-Fitness-Level „Bronze" |
| **Fitnessstudio** | 4-stufiges Skill-Level pro UE: „Ersthelfende*r" → „SanH-Assistenz" → „SanH-Operator" → „SanH-Profi" |
| **Fitness Challenge** | Block-Abschluss-Challenge: Mini-OSCE in <15 min bestanden + 1 Peer-Feedback gegeben |

| UE | Badge | Voraussetzung |
|---|---|---|
| 1 | Atemwegs-Inspektor | Obere/untere Atemwege anhand Demo-Modell korrekt beschriften, Steuerung erläutern |
| 2 | Atem-Detektiv | Atemkontrolle in <10 s mit Sehen-Hören-Spüren korrekt durchgeführt |
| 3 | O2-Berechner | O2-Flascheninhalt + Vorrat in Minuten für zwei Aufgaben korrekt berechnet, Sicherheits-Checkliste komplett |
| 4 | Aspiration-Profi | Ablaufschema Aspiration Erw. (S. 51) am Schauspielpatient korrekt durchgeführt |
| 5 | Atemnot-Spezialist | Asthma-Anfall + Hyperventilation in zwei Szenarien richtig versorgt (Lippenbremse, Rückatmung) |
| 6 | Szenario-Meister | Integriertes Atemnot-Szenario mit Bewusstlosigkeit + HLW-Übergang in <8 min |

**Sichtbarkeit:** Badge-Übersicht am Pinboard / digitale Anzeige. Bei 6/6 → Bronze-Auszeichnung beim Blockende-Briefing.
...
- Warum ist die Nase der 'bessere' Atemweg als der Mund (Anfeuchten, Anwärmen, Reinigen)?
...
### Reflexionsfragen
- Wann würdet ihr die Atemkontrolle abbrechen, um direkt mit HLW zu beginnen?
- Was ist der Unterschied zwischen 'Atemfrequenz' und 'Atemqualität'?
...
### Material
- Übungs-O2-Flasche (5 L, gefüllt) + Flowmeter + Maske + Brille
- Defekte/Restdruckflasche zur Demo
- O2-Berechnungs-Aufgabenblatt (1/TN)
- Stoppuhr
...
### Reflexionsfragen
- Warum darf die O2-Flasche nie ganz leer werden?
- Welche Maßnahme ergreift ihr, wenn die Maske vom Patienten nicht toleriert wird (Unruhe, Klaustrophobie)?
...
- Aspiration-Trainings-Set (Prothese, kleine Teile, Brei)
- Moulage-Set (Insektenstich am Hals, Zyanose-Lippenstift)
- Asthma-Inhalations-Demo (Plastik-Inhalator)
- Lippenbremse-Anleitung + Übungs-Strohhalm
- Rollenkarte „Aspiration Erwachsener beim Essen"
...
### Reflexionsfragen
- Welche Eskalationsstufen gibt es im Aspiration-Schema, bevor HLW eingeleitet wird?
- Welche Rolle spielt die Lippenbremse physiologisch (Verlängerung der Ausatmung, höherer Innendruck in den Bronchien)?
...
### Material
- Schauspielpatienten (mind. 2, einer kann Kind spielen)
- Kohlendioxid-Rückatmungstüte
- Eisbeutel / kalte Kompressen
- Moulage-Set (Insektenstich am Hals, Zyanose)
- Rollenkarten (Hyperventilation, Krupp-Kind, Insektenstich, Beinahe-Ertrinken)
- Lippenbremse-Anleitung
- Demo-Audio Krupp-Husten
...
- Warum ist Krupp fast nie ein echter Notfall, obwohl der Husten dramatisch klingt?
...
### Reflexionsfragen
- Welche Eskalationsstufe zwischen den einzelnen Atemnot-Schemata würdet ihr am ehesten vergessen?
- Was würdet ihr euch für die nächste HLW-UE wünschen (worauf sollen wir besonders achten)?

---

## 12 Block-Abschluss (in UE 6 integriert)

### Mini-OSCE (Objective Structured Clinical Examination)
- **Dauer:** 15 min pro TN (oder als Stationen-Format mit 4 Stationen × 4 min)
- **Stationen:** 1) Atemkontrolle in <10 s am Phantom, 2) Aspiration-Schema Erwachsener (S. 51), 3) O2-Berechnung (Druck × Volumen, Vorrat in min), 4) Asthma + Lippenbremse am Schauspielpatient
...
- „Welche Atemstörung würdet ihr im Einsatz am meisten fürchten?"
- „Was nehmt ihr für euren ersten echten Atemnot-Einsatz mit?"
- „Welche Frage ist offen geblieben?"

### Badge-Vergabe
- 6/6 Badges = SanH-Fitness-Level „Bronze"
...
| Lerntyp | Anpassung |
|---|---|
| **Visuell** | Anatomie-Plakat, Atemwegsmodell, Moulage-Demos, Lippenbremse-Schaubild |
| **Auditiv** | Atemgeräusch-Demos (Schnappatmung, Stridor, Krupp-Husten, Rasseln), Trainer-Demos, Partnerdiskussion |
| **Kinästhetisch** | Praxis-Anteil 70 %, Atemkontrolle-Übungen, Rollenspiele, Lippenbremse-Strohhalm |
| **Lesen/Schreiben** | Blockhefter mit Berechnungs-Beispielen, Reflexionsbögen, Aspiration-Schemata |

| Bedarf | Anpassung |
|---|---|
| **Sprachbarrieren** | Aspiration-Schemata als Bildtafel, Schlüsselbegriffe auf Karteikarten |
| **Erfahrene TN** (z. B. mit Rettungsdienst-Vorerfahrung) | Als Peer-Coach einsetzen, Bonusaufgaben (z. B. O2-Berechnung mit Reserve-Logik für Mehrpatienten-Szenarien) |
| **Unsichere TN** | Kleingruppen zuerst, dann vor Plenum; ausdrücklich Fehlerfreundlichkeit |
| **TN mit Behinderung** | Material vorab klären, Atemübungen ggf. im Sitzen, alternative Übungsformen |
...
| Reanimations-Zertifikat (BLS) nicht älter als 12 Monate | für UE 4 (Aspiration-Schemata) und als Brücke zu LF III |
| Erfahrung mit Atemnot-Schauspielpatienten | für UE 4, UE 5, UE 6 |
| Einweisung in das ortsansässige O2-Gerät | für UE 3 |
...
|---|---|
| TN bekommt während Lippenbremse-Übung Schwindel | Sitzplatz in Reichweite, Übung kurz halten, klare Pause-Ansage |
| Übungs-Patient kollabiert real | Defibrillator im Raum, Notfallplan (andere TN übernehmen) |
| O2-Flasche undicht | Vor UE Dichtigkeit prüfen, Ersatzflasche in Reserve |
| TN mit Klaustrophobie bei O2-Maske | Alternative Atem-Brille anbieten, kurze Demonstration |
| TN bricht ab | Einzelgespräch, ggf. Wiederholung in Folgekurs |

**Notfall-Equipment im Raum:** Verbandskasten, AED, Notfallmedikamenten-Liste der TN-Allergien, zweite O2-Flasche.
...
### 17.1 Anatomie-Karte Atemwege (DIN A5)
...
│    Bronchien (re/li)                   │
│    Lungenbläschen (Gasaustausch O2/CO2)│
│                                        │
│  Steuerung:                            │
│    Atemzentrum im verlängerten Rücken- │
│    mark (unwillkürlich); willkürlich   │
│    beeinflussbar                       │
└────────────────────────────────────────┘
```
...
│   □ Angst, Unruhe                      │
│                                        │
│  AUS DER ANAMNESE (SAMPLER):           │
│   □ Bekannte Erkrankung (z. B. Asthma) │
│   □ Psychische Erregung                │
│   □ Bewusstseinsstörung                │
│   □ Hinweis auf Verletzung / Insekten- │
│     stich                              │
│                                        │
│  ATEMQUALITÄT:                         │
│   □ Frequenz (zu hoch / zu niedrig)    │
│   □ Tiefe (flach / tief)               │
│   □ Rhythmus (regelmäßig / unregel-    │
│     mäßig)                             │
└────────────────────────────────────────┘
```
...
### 17.4 O2-Berechnungs-Karte (DIN A5)

```
┌────────────────────────────────────────┐
│  FLASCHENINHALT (Liter):               │
│    Druck (bar) × Volumen (L)           │
│    Beispiel: 5 L × 100 bar = 500 L     │
│                                        │
│  VORRAT (Minuten):                     │
│    (Inhalt − Restdruck-Reserve) /      │
│     Verbrauch (L/min)                  │
│    Beispiel: (500 − 150) / 2 L/min     │
│            = 175 min ≈ 3 h             │
│                                        │
│  Restdruck-Reserve: ca. 30 bar         │
│                                        │
│  SICHERHEIT:                           │
│   □ Kein Öl/Fett an Ventilen           │
│   □ Schutzkappe auf Flasche            │
│   □ Flasche in Befestigung             │
│   □ Erst Ventil zu, dann Flowmeter zu  │
└────────────────────────────────────────┘
```

### 17.5 Lippenbremse-Anleitung (DIN A5)
...
### 17.6 Hyperventilations-Rückatmung (DIN A5)
...
7. Lippenbremse-Anleitung
8. Hyperventilations-Rückatmung-Karte
9. Pflicht-Ablaufschema Aspiration Erwachsene (S. 51, Originalkopie)
10. Pflicht-Ablaufschema Aspiration Kinder (S. 52, Originalkopie)
11. Symptom-Übersicht: Asthma / Hyperventilation / Krupp / Insektenstich / Beinahe-Ertrinken
