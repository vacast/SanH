...
|---|---|---|
| LZ-1 | Eine Bewusstseinsstörung durch einfache Untersuchungen erkennen (ZORRO, 3 Lagen) und notwendige Maßnahmen einleiten (Atemkontrolle, stabile Seitenlage, PAKET) | Anwenden |
| LZ-2 | Die stabile Seitenlage auch aus ungewöhnten Ausgangslagen (Bauchlage, Helmträger) durchführen und die adäquate Vitalzeichenkontrolle sicherstellen | Anwenden |
| LZ-3 | Die Helmabnahme bei einem bewusstlosen Motorradfahrer mit 2 Helfern achsengerecht durchführen und einen Patienten mit HWS-/Kopfverletzung in Neutralposition lagern | Anwenden |
| LZ-4 | Symptome eines Schlaganfalls (FAST, Halbseitenlähmung, Sprach-/Schluckstörung) erkennen und den Patienten sachgerecht mit erhöhtem Oberkörper lagern | Anwenden |
| LZ-5 | Einen Krampfanfall erkennen (Phasen, Aura, Nachschlaf), während des Anfalls richtig reagieren (NICHT festhalten, Gegenstände entfernen, ggf. O2) und die Nachsorge (Bodycheck, SSL, PAKET) durchführen | Anwenden, Reflektieren |
| LZ-6 | Eine Unterzuckerung erkennen, BZ-Messung korrekt durchführen (seitliche Fingerkuppe, OHNE Auspressen, ersten Tropfen verwerfen, Zeit dokumentieren) und je nach Bewusstseinslage richtig handeln | Anwenden |
...
|---|---|---|
| Anatomie-Modell Gehirn (oder Bildtafel Nervensystem) | 1 | UE 1 Theorie-Input |
| Reanimationsphantom | 1 | UE 1 Stabile Seitenlage, UE 4 Krampf-Demo |
| Motorradhelm (Übungs-Helm) | 2 | UE 2 Helmabnahme |
| Bildtafel HWS-Immobilisation / Manual-Inline-Stabilisation | 1 | UE 2 |
| Schauspielpatienten (Rekrutierung mind. 3 Personen) | 3 | UE 3 Schlaganfall, UE 4 Krampfanfall, UE 6 Vergiftung |
| Moulage-Set (halbseitige Lähmung, Schaum vor Mund, Erbrochenes, Tablettenreste, Einstichstellen) | 1 Set | UE 3, UE 4, UE 6 |
| Stoppuhr (mehrere, sichtbar) | 3 | alle UE |
| Sauerstoff-Flasche (Übungsmodell, mit Maske) | 1 | UE 4 Krampf-Anfall |
| Weiche Unterlage, Kissen, Polster (Schutzmaterial) | mehrere | UE 4 Krampf-Schutz |
| Blutzuckermessgerät + Teststreifen + Lanzetten + Hautdesinfektion + Tupfer + Pflaster | 3 Sets | UE 5 BZ-Messung |
| Stichfester Abwurfbehälter | 1 | UE 5 |
| Traubenzucker, süße Getränke (Apfelschorle, Cola) | mehrere | UE 5 Unterzuckerung |
| Wolldecken, Rettungsdecken, trockene Wechselkleidung | mehrere | UE 6 Unterkühlung |
| Warme gezuckerte Getränke (Tee) | mehrere Becher | UE 6 Frühstadium Unterkühlung |
| Kühlkompressen / feuchte Tücher / Wadenwickel-Material | mehrere | UE 6 Hitzschlag/Sonnenstich |
| Attrappe Medikamenten-Packung / Pflanzenschutzmittel-Flasche / Reiniger | mehrere | UE 6 Vergiftung |
| Injektionsbesteck (Demo, stichsicher verpackt) | 1 | UE 6 Vergiftung |
| Telefon (alt, mit Kabel) | 1 | UE 6 Notruf Giftinformationszentrale |
...
| Element | Umsetzung in LF V |
|---|---|
| **Punkte** | 1 Punkt pro richtiger Anwendung im Übungssetting, max. 1 Punkt pro TN/UE |
| **Badges** | 6 Badges (1 pro UE), s. Tabelle unten |
| **Streak** | 6/6 UE anwesend + bestanden = SanH-Fitness-Level „Silber" (Aufstieg von Bronze nach LF I) |
| **Fitnessstudio** | 4-stufiges Skill-Level pro UE: „Ersthelfende*r" → „SanH-Assistenz" → „SanH-Operator" → „SanH-Profi" |
| **Fitness Challenge** | Block-Abschluss-Challenge: Mini-OSCE in <20 min bestanden + 1 Peer-Feedback zu Bewusstseins-Check gegeben |

| UE | Badge | Voraussetzung |
|---|---|---|
| 1 | ZORRO-Operator | Bewusstseins-Check mit ZORRO + Unterscheidung 3 Lagen + Stabile Seitenlage in <90 s |
| 2 | Helm-Profi | Helmabnahme mit 2 Helfern achsengerecht in <2 min ohne ruckartige HWS-Bewegung |
| 3 | Schlaganfall-Ersthelfer | FAST-Check in <2 min + Oberkörper-Hochlagerung + PAKET |
| 4 | Anfall-Bändiger | Krampfanfall-Maßnahmen (Schutz + Nachsorge) korrekt am Schauspielpatient demonstriert |
| 5 | Zucker-Checker | BZ-Messung mit allen 8 Schritten korrekt durchgeführt (seitliche Fingerkuppe, OHNE Auspressen, erster Tropfen verworfen, Zeit dokumentiert) |
| 6 | Gift-Analyst | Aufnahmeweg korrekt zugeordnet + Eigenschutz priorisiert + Notruf mit Giftinformationszentrum-Info |

**Sichtbarkeit:** Badge-Übersicht am Pinboard / digitale Anzeige. Bei 6/6 → Silber-Auszeichnung beim Blockende-Briefing.
...
**Trainer-Prinzip:** Nicht länger als 15 min reden. Bei Krampfanfall- und Schlaganfall-Simulationen Stoppuhr und Schutzmaterial bereithalten, SP vorher briefen.
...
### Material
- Anatomie-Modell Gehirn oder Bildtafel Nervensystem
- Reanimationsphantom (für Stabile Seitenlage)
- Stoppuhr
...
- Wie unterscheidet sich die stabile Seitenlage bei einem Patienten mit vermuteter HWS-Verletzung (→ UE 2)?
...
### Material
- 2 Motorradhelme (Übungs-Helme, ggf. mit Visier)
- 2 Helfer-TN pro Übung
- Reanimationsphantom
- Bildtafel HWS-Immobilisation / Manual-In-Line-Stabilisation (oder Cervical-Stiffneck-Demo)
- Stoppuhr
...
### Reflexionsfragen
- Welche Information über den Unfallmechanismus hilft euch, eine HWS-Verletzung zu vermuten?
- Wie würdet ihr vorgehen, wenn der Patient im Helm erbricht (Aspirationsgefahr)?
...
### Material
- Schauspielpatient (Rekrutierung!)
- Moulage-Set (halbseitige Lähmung simulieren, hängender Mundwinkel)
- Kissen zur Oberkörper-Hochlagerung
- Stoppuhr
- Reflexionsbogen „FAST-Test"
...
- Wann ist die Oberkörper-Hochlagerung kontraindiziert (z. B. bei Bewusstlosigkeit, Schock)?
...
### Material
- Schauspielpatient (KRITISCH: vorab briefen, realistische Krampf-Simulation, Sicherheits-Briefing!)
- Weiche Unterlage, Kissen, Polster (Schutzmaterial)
- Sauerstoff-Flasche (Übungsmodell, mit Maske)
- Moulage-Set (Schaum vor Mund, ggf. leicht blutig)
- Stoppuhr (Krampf-Dauer sichtbar!)
- Reflexionsbogen „Was habe ich während des Anfalls getan?"
...
- Woran erkennt ihr, dass der Krampf durch eine Unterzuckerung ausgelöst wurde (Verdacht in Anamnese)?
...
### Material
- 3 Blutzuckermessgeräte + Teststreifen + Lanzetten + Hautdesinfektion + Tupfer + Pflaster
- Kompresse, stichfester Abwurfbehälter
- Stoppuhr (für Einwirkzeit Desinfektion)
- Übungs-Arm oder Partner-TN
- Traubenzucker, süße Getränke (Apfelschorle, Cola)
- Schauspielpatient für Unterzuckerungs-Szenario
- Reflexionsbogen „BZ-Messung Schritt-für-Schritt"
...
### Material
- 3 Bilder/Tafeln (Obdachloser im Winter, Wanderer mit rotem Kopf, Kleinkind mit Medikamenten-Packung)
- Attrappe Medikamenten-Packung / Pflanzenschutzmittel-Flasche / Reiniger
- Injektionsbesteck (Demo, stichsicher verpackt)
- Wolldecken, Rettungsdecken, trockene Wechselkleidung
- Warme gezuckerte Getränke
- Kühlkompressen / feuchte Tücher / Wadenwickel-Material
- Telefon (alt, mit Kabel) für Notruf-Simulation
- Schauspielpatient für Vergiftungs-Szenario
- Moulage-Set (Einstichstellen, Erbrochenes)
- Stoppuhr
...
- Wann ruft ihr die Giftinformationszentrale (19240) an, wann die 112?

---

## 12 Block-Abschluss (in UE 6 integriert, +15 min falls gewünscht)

### Mini-OSCE (Objective Structured Clinical Examination)
- **Dauer:** 20 min pro TN (oder als Stationen-Format mit 4 Stationen × 5 min)
- **Stationen:** 1) ZORRO + SSL aus Bauchlage am Phantom, 2) FAST-Check + Oberkörper-Hochlagerung am Schauspielpatient, 3) Krampfanfall-Versorgung am Schauspielpatient (Schutz + Nachsorge), 4) BZ-Messung am Partner ODER Vergiftungs-Notruf mit Giftinformationszentrum
...
## 13 Differenzierung und Inklusion

| Lerntyp | Anpassung |
|---|---|
| **Visuell** | Bildtafeln (Gehirn, HWS, FAST-Schema), Moulage-Demos, FAST-Farbcode, Aufnahmewege-Plakat |
| **Auditiv** | Trainer-Demos, Audio-Hooks (Krampf-Geräusche, Verkehrslärm in UE 6), Partnerdiskussion |
| **Kinästhetisch** | Praxis-Anteil 70 %, Helm-An/-Aus, BZ-Messung, Krampf-Schutz-Übung, CO-Eigenschutz-Trockenübung |
| **Lesen/Schreiben** | Blockhefter mit Zusammenfassungen, Reflexionsbögen, Schritt-für-Schritt-Anleitungen |

| Bedarf | Anpassung |
|---|---|
| **Sprachbarrieren** | FAST-Schema ist international verständlich, Bildtafeln für Aufnahmewege, Schlüsselbegriffe auf Karteikarten, langsam sprechen |
| **Erfahrene TN** (z. B. mit Epilepsie-Erfahrung im privaten Umfeld, Sanitäts-/Rettungsdienst-Vorerfahrung) | Als Peer-Coach für Krampf-Simulation einsetzen, Bonusaufgaben (z. B. Sondersituation „Status epilepticus", BZ-Troubleshooting) |
| **Unsichere TN** | Krampf-Simulation zuerst in Kleingruppe, dann vor Plenum; Schutzmaterial bereitstellen; klare Stopp-Regel |
| **TN mit Diabetes** | Vor Block erfragen, Eigenmessung ermöglichen, ggf. Pause einplanen |
| **TN mit Behinderung** | Material vorab klären, Übungs-Helm ggf. anpassen, alternative Reflexionsformen |

---

## 14 Trainer-Qualifikation
...
| Reanimations-Zertifikat (BLS) nicht älter als 12 Monate | für UE 4 (Krampf + Atemstillstand, CPR-Übergang) |
| Erfahrung mit Schauspielpatienten für Krampf- und Schlaganfall-Simulation | für UE 3 + 4 |
| Erfahrung in Eigenschutz-Briefing (CO-Vergiftung, Infektionsschutz, Lanzetten) | für UE 5 + 6 |
| Hospitation bei erfahrenem SanH-Ausbilder (1×) | vor Erst-Einsatz |

**Co-Trainer empfohlen ab 8 TN** (1 Trainer : 8 TN Maximum), bei Krampf-Simulation zwingend 2 Trainer.

---

## 15 Risikomanagement und Notfallplan
...
**Notfall-Equipment im Raum:** Verbandskasten, AED, Notfallmedikamenten-Liste der TN-Allergien, Traubenzucker-Reserve, Sauerstoff-Flasche (Übungsmodell), stichfester Abwurf.
...
| Schauspielpatienten-Debriefing | nach Krampf-UE | Trainer + SP |
| Material-Check (Helme, BZ-Geräte, Stechhilfen) | vor Block | Materialverantwortlicher |

**Erfolgskriterium:** ≥ 80 % der TN bestehen Mini-OSCE im ersten Anlauf.

---

## 17 Anhang: Druckvorlagen

### 17.1 ZORRO-Karte (DIN A5)
...
```
┌─────────────────────────────────┐
│  1. Nahen Arm angewinkelt       │
│  2. Fernen Arm über Brust       │
│  3. Fernes Bein angewinkelt     │
│  4. An Schulter + Hüfte drehen  │
│  5. Mund = tiefster Punkt       │
│  6. Kopf überstreckt            │
│                                 │
│  Bei HWS-Verdacht:              │
│  → OHNE Kopfpolsterung!         │
...
### 17.4 BZ-Messung-Schritt-Karte (DIN A5)

```
┌─────────────────────────────────┐
│  1. Händedesinfektion + Einwirk.│
│  2. Seitliche Fingerkuppe wählen│
│  3. Lanzette seitlich ansetzen  │
│  4. Ersten Tropfen verwerfen    │
│  5. OHNE Auspressen Blut nehmen │
│  6. Streifen aufnehmen          │
│  7. Ergebnis + Uhrzeit dokument.│
│  8. Lanzette in Abwurf, Wunde   │
│     versorgen (Pflaster)        │
└─────────────────────────────────┘
```

### 17.5 Aufnahmewege-Vergiftung-Karte (DIN A5)
...
│        Insektengift, Pflaster   │
│  Intravenös: Drogen,            │
│        Schlangenbiss            │
│                                 │
│  Giftinformationszentrale:      │
│  Vorwahl 19240                  │
│  (Auskunftsstelle, kein Notruf) │
│  Notruf: 112 bei Symptomen      │
└─────────────────────────────────┘
```

### 17.6 Helmabnahme-2-Helfer-Karte (DIN A5)

```
┌─────────────────────────────────┐
│  Helfer A (Kopf oben):          │
│  → Faustgriff Unterkiefer +     │
│    Hand am Hinterkopf           │
...
│  → Visier öffnen                │
│  → Kinnriemen lösen             │
│  → Helm kippelnd abziehen       │
│  → A übernimmt Kopf von unten   │
└─────────────────────────────────┘
```
...
5. Stabile-Seitenlage-Schritte
6. Helmabnahme-2-Helfer-Schaubild
7. FAST-Karte
8. Krampfanfall-Phasen-Schaubild (tonisch/klonisch/Nachschlaf)
9. BZ-Messung-Schritt-Karte
10. Aufnahmewege-Vergiftung-Karte
11. Unterkühlungs-Stadien (Frühstadium/fortgeschritten)
12. Unterkühlungs-Maßnahmen-Karte (aktive Bewegung vs. NICHT bewegen)
13. Hitzschlag/Sonnenstich-Vergleichs-Karte
14. Giftinformationszentrum-Karte
15. Reflexionsbögen (3 Stück)

---

## 18 Versions-Historie
