...
## 1 Block-Lernziele (Bezug: Kommentar S. 46 „Das sollten Sie jetzt wissen und können")

Am Ende des Blocks können die Teilnehmer:innen (TN):

| Nr. | Lernziel | Taxonomie* |
|---|---|---|
| LZ-1 | Bei einem Massenanfall von Verletzten (MANV) Eigenschutz wahren, Überblick verschaffen, gezielten Notruf absetzen und Weisungen von Führungskräften (LNA/OrgL) befolgen | Anwenden |
| LZ-2 | Auslösende Faktoren für Gewalt im Einsatz erkennen und Deeskalationsstrategien (ruhiges Auftreten, Talk down, „Stop!", Rückzug, Hilfe anfordern) anwenden | Anwenden, Bewerten |
| LZ-3 | Stresssyndrom-Symptome (Lethargie, somatische Störungen, Schlafstörungen, Flashbacks, Vermeidung, Substanzmissbrauch) bei sich und anderen erkennen | Erkennen, Reflektieren |
| LZ-4 | Einsatznachsorge-Angebote der Johanniter (24h-Meldezentrale 0800 2699701, kostenfrei) kennen und aktivieren | Anwenden |
...
|---|---|
| **Teilnehmerorientierung** | Reflexionsphase zu Blockbeginn: „Welche Sondersituation habt ihr selbst schon erlebt?" (Erfahrung wird ernst genommen) |
| **Handlungsorientierung** | Mind. 65 % Praxis: lange Rollenspiele mit Schauspielpatienten, Table-Top-Übung MANV, Gruppendiskussion Einsatznachsorge |
| **Lernfeldorientierung** | Schnittstellen zu LF I (Eigenschutz, Notruf, ABCDE), LF IV (MANV-Polytrauma), LF VI (Schmerz als Stress-Faktor und Warnsignal) |
| **Praxisorientierung** | Schauspielpatienten ab UE 2 (Gewalt-Rollenspiel); UE 4 komplett praxisorientiert (4 Mini-Stationen) |
...
| Element | Umsetzung in LF VII |
|---|---|
| **Punkte** | 1 Punkt pro Deeskalations-Versuch im Rollenspiel, max. 1 Punkt pro TN/UE |
| **Badges** | 4 Badges (1 pro UE), s. Tabelle unten |
| **Streak** | 4/4 UE anwesend + bestanden = SanH-Fitness-Level „Krisen-Manager:in" |
| **Fitnessstudio** | 4-stufiges Skill-Level pro UE: „Beobachter:in" → „Erst-Reaktionär:in" → „Deeskalations-Profi" → „Krisen-Manager:in" |
| **Fitness Challenge** | Block-Abschluss-Challenge: Mini-OSCE in <12 min bestanden + 1 Peer-Feedback gegeben + Reflexionsbogen ausgefüllt |

| UE | Badge | Voraussetzung |
|---|---|---|
| 1 | MANV-Operator | MANV-Lagekarte in <90 s ausgefüllt + korrekter Notruf mit „mehrere Verletzte" |
| 2 | Deeskalations-Profi | Konfliktsituation in Rollenspiel in <3 min deeskaliert + 1 Deeskalationsstrategie verbalisiert |
| 3 | Einsatznachsorge-Scout | 4 von 6 Stresssyndrom-Symptomen korrekt zugeordnet + Hilfsangebot aktiviert |
| 4 | Krisen-Manager:in | 4 Mini-Stationen à 3 min bestanden + Reflexion + Peer-Feedback |

**Sichtbarkeit:** Badge-Übersicht am Pinboard / digitale Anzeige. Bei 4/4 → „Krisen-Manager:in"-Auszeichnung beim Blockende-Briefing.
...
**Trainer-Prinzip:** Nicht länger als 15 min reden. Rollenspiele dürfen länger dauern (bis 20 min), aber Theorie bleibt kurz. Bei Gewalt-Themen: Debriefing IMMER mit Trainer:in anwesend.
...
- Flipchart + Marker
- Funkgeräte oder Walkie-Talkies (4 Stück)
- Verbandsmaterial + Moulage-Set
- Schauspielpatienten (mind. 2 für Table-Top)
- Stoppuhr
- MANV-Lagekarte (DIN A4, s. Druckvorlage 17.1)
...
- Wann ist eine Lage für euch „nicht mehr tragbar" und ihr müsst Hilfe anfordern?
...
- Stoppuhr
- Reflexionsbogen „Was hat gut funktioniert?" (1/TN)
...
- Welche Strategie würdet ihr bei einer Person anwenden, die unter Drogeneinfluss steht (Sprache verwaschen, nicht ansprechbar)?
...
- TN kennen das Einsatznachsorge-Angebot der Johanniter und können es aktivieren.
- TN reflektieren ihre eigene Belastungsfähigkeit.

### Material
- Stresssyndrom-Symptom-Karten (8 Stück)
- Fallbeispiel-Karten „Einsatznachsorge" (3 echte Fallvignetten, anonymisiert)
- Info-Flyer „Einsatznachsorge Johanniter" (1/TN)
- Reflexionsbogen „Mein Stress-Selbsttest" (1/TN)
- Flipchart + Marker
...
- Wer in eurem Umfeld würde als Erste:r merken, wenn es euch nicht gut geht?
...
- TN reflektieren ihre Lernfortschritte und erhalten die Abschluss-Badges.

### Material
- Schauspielpatienten (mind. 3)
- Rollenkarten „Konflikt-Szenarien" (Rest aus UE 2)
- Funkgeräte
- Verbandsmaterial + Moulage-Set
- Rettungsdecken + Wolldecken
- Mini-OSCE-Bogen (s. Druckvorlage 17.6)
- 4 OSCE-Fallkarten (s. Druckvorlage 17.6)
- Stoppuhr
...
- Was würdet ihr einem neuen SanH-Kollegen raten, der zum ersten Mal in eine Sondersituation kommt?
...
- **Stationen:**
  1. MANV-Funknotruf mit Lagekarte (Szenario-Karte ziehen)
  2. Deeskalation Rollenspiel (Schauspielpatient als „aggressiver Angehöriger", 90 s + Trainer:in als Beobachter)
  3. Stresssyndrom-Erkennung (Fallvignette → 2 Symptome nennen + passende Maßnahme wählen)
  4. Einsatznachsorge-Aktivierung (Meldezentrale-Nummer nennen + persönlichen Notfall-Plan skizzieren)
...
| Lerntyp | Anpassung |
|---|---|
| **Visuell** | Deeskalations-Übersichtstafel, MANV-Lagekarten-Vorlage, Flipcharts |
| **Auditiv** | Trainer-Demos, Rollenspiel-Hooks, Gruppendiskussion |
| **Kinästhetisch** | Praxis-Anteil 75 %, Hands-on-Rollenspiele, FUNK-Üben |
| **Lesen/Schreiben** | Blockhefter mit MANV-Checkliste, Reflexionsbögen, Flyer |

| Bedarf | Anpassung |
|---|---|
| **Sprachbarrieren** | Schlüsselbegriffe auf Karteikarten, visuelle Deeskalations-Symbole, langsam sprechen |
| **Erfahrene TN** (z. B. mit Pflege-/Polizei-Vorerfahrung) | Als Peer-Coach für Deeskalation einsetzen, Bonusaufgaben (z. B. MANV-Szenario weiterentwickeln) |
| **Unsichere TN** | Bei Gewalt-Rollenspielen zunächst Beobachterrolle, dann Mitspielen; Ausstiegs-Signal klarmachen |
| **TN mit Trauma-Erfahrung** | Vorab-Gespräch, alternative Aufgaben (Beobachten + Protokollieren), Belastungs-Check nach UE 3 |
...
|---|---|
| TN wird durch Gewalt-Rollenspiel emotional getriggert | Vorab-Gespräch, Ausstiegs-Signal, Einzel-Debriefing, ggf. Abbruch |
| Übungs-Patient kollabiert real | Defibrillator im Raum, Notfallplan (andere TN übernehmen) |
| TN hat reale Trauma-Erfahrung mit MANV/Gewalt | Alternative Aufgabe, Einzelbetreuung, ggf. Verweis auf Einsatznachsorge 0800 2699701 |
| Schauspielpatient:in wird in Rolle „zu echt" | Vorab-Briefing zur Rollen-Begrenzung, klare Stopp-Signale |
...
**Notfall-Equipment im Raum:** Verbandskasten, AED, Notfallmedikamenten-Liste der TN-Allergien, Mobiltelefon für Notruf, Einsatznachsorge-Flyer zur sofortigen Weitergabe.
...
**Erfolgskriterium:** ≥ 80 % der TN bestehen Mini-OSCE im ersten Anlauf + alle TN kennen die Einsatznachsorge-Nummer.

---

## 15 Anhang: Druckvorlagen

### 15.1 MANV-Lagekarte (DIN A4, 1/TN)
...
### 15.2 Deeskalations-Übersichtstafel (DIN A2, laminiert)
...
Ziel: Piktogramme nutzen, Dolmetscher-Hotline, Notarzt
```
...
meidet den Badebereich, trinkt mehr Alkohol als sonst.
...
berichtet, TN reagiert nicht mehr auf Witze über Unfälle.
Frage an TN: Welche Hinweise aus dem Umfeld? Was tun?
→ Antwort: sozialer Rückzug, Vermeidung → Angehörige ansprechen
   + Meldezentrale
```

### 15.5 Reflexionsbogen „Mein Stress-Selbsttest" (DIN A4, 1/TN)
...
│   ☐ Funknotruf korrekt (mehrere Verletzte, Anzahl, Art)   │
│   ☐ Lagekarte vollständig ausgefüllt                       │
│   ☐ bestanden  ☐ nicht bestanden                           │
│                                                            │
│ Station 2: Deeskalation Rollenspiel (SP)                  │
│   ☐ Ruhiges Auftreten beibehalten                          │
│   ☐ Mind. 1 Deeskalationsstrategie angewendet             │
│   ☐ „Stop!" oder Hilfe-Anforderung wenn nötig              │
│   ☐ bestanden  ☐ nicht bestanden                           │
│                                                            │
│ Station 3: Stresssyndrom-Erkennung                        │
│   ☐ 2 Symptome korrekt benannt                             │
│   ☐ Passende Maßnahme gewählt                              │
│   ☐ bestanden  ☐ nicht bestanden                           │
│                                                            │
│ Station 4: Einsatznachsorge-Aktivierung                   │
│   ☐ Meldezentrale 0800 2699701 genannt                     │
│   ☐ Persönlicher Notfall-Plan skizziert                   │
│   ☐ bestanden  ☐ nicht bestanden                           │
│                                                            │
...
### 15.7 Blockhefter-Inhalt (1/TN, vor Blockbeginn)
...
8. Fallvignetten Einsatznachsorge (3 echte Beispiele)
