...
## 1 Block-Lernziele (Bezug: Kommentar S. 12 „Das sollten Sie jetzt wissen und können")

Am Ende des Blocks können die Teilnehmer:innen (TN):

| Nr. | Lernziel | Taxonomie* |
|---|---|---|
| LZ-1 | Eigenschutz- und Hygienemaßnahmen (BSI, Händedesinfektion) unter realitätsnahen Bedingungen anwenden | Anwenden |
| LZ-2 | Das ABCDE-Schema am Patienten prioritätengerecht abarbeiten und lebensrettende Sofortmaßnahmen einleiten | Anwenden |
| LZ-3 | Einen Notruf mit den 5 W's situationsangemessen absetzen und Rettungsmittel-Anforderungen begründen | Anwenden |
| LZ-4 | Eine vollständige Anamnese (SAMPLER) erheben, einen PAKET-Ablauf durchführen und Eigenwärme erhalten | Anwenden |
...
|---|---|---|
| Händedesinfektionsmittel (mit Fluoreszenzmarker) | 1 Flasche/TN | UE 1 |
| Schwarzlichtlampe (UV-A) | 1 | UE 1 Lernziel-Check |
| Einweghandschuhe (S/M/L) | 20 Paare | UE 1, alle UE |
| Übungsphantom Reanimationspuppe | 1 | UE 2 Bodycheck-Demo |
| Moulage-Set (Wunden, Blut) | 1 Set | UE 2, UE 4 |
| Demo-Material Atemwege (Larynx-Tubus-Demo) | 1 | UE 2 Demo |
| Telefon (alt, mit Kabel) | 1 | UE 3 Notruf-Simulation |
| Lautsprecher / Audio-Datei Verkehrslärm | 1 | UE 3 Hook |
| Rettungsdecke (Gold/Silber) | 5 | UE 4 Eigenwärme |
| Wolldecken | 5 | UE 4 Eigenwärme |
| Übungs-Dokumentationsbogen (DIVI-Standard) | 1/TN | UE 4, UE 6 |
| Schauspielpatienten (Rekrutierung mind. 2 Personen) | 2 | UE 4, UE 5 |
| Rollenkarten (Patientengruppen: Kind, alt, behindert, Ausländer) | 4 | UE 5 |
...
|---|---|---|
| 1 | Hygiene-Profi | Händedesinfektion unter UV-Lampe vollständig benetzt, keine Lücken |
| 2 | ABCDE-Operator | Bodycheck in <2 min korrekt durchgeführt |
| 3 | Notruf-Meister | Notruf in <60 s mit allen 5 W's abgesetzt |
| 4 | PAKET-Anwender | PAKET-Ablauf in <5 min an Schauspielpatient komplett durchgeführt |
| 5 | Patientenflüsterer | 4-S-Regel in Rollenspiel angewendet + Peer-Feedback erhalten |
| 6 | Übergabe-Profi | strukturierte Übergabe in <90 s mit allen Pflichtpunkten |
...
**Trainer-Prinzip:** Nicht länger als 15 min reden. Lieber 3 × 5 min Theorie mit Praxis-Interleaving.
...
### Material
- Händedesinfektionsmittel mit Fluoreszenzmarker
- UV-A-Schwarzlichtlampe
- Einweghandschuhe (S/M/L)
- Händedesinfektions-Schaubild (DIN A3, laminiert)
...
- **Bei sehr trockenen Händen:** Hautschutzcreme danach erwähnen (DIN-konformer Hinweis).
- **Inklusion:** Linkshänder-TN gleichberechtigt üben, ggf. zweites Handschuh-Paar.

### Reflexionsfragen
- Wie könnt ihr sicherstellen, dass ihr im Einsatz immer die Reihenfolge einhaltet?
- Was ist, wenn das Händedesinfektionsmittel im Einsatz ausgegangen ist?
...
### Material
- Übungsphantom (Reanimationspuppe, auch für Bodycheck nutzbar)
- Moulage-Set (Wunden, simulierte starke Blutung)
- Demo-Larynx-Tubus (oder Bild)
...
- Wann ist die Anwendung des ABCDE nicht sinnvoll?
...
- TN setzen einen Notruf mit den 5 W's situationsangemessen ab.

### Material
- Telefon (alt, mit Kabel) + Lautsprecher
- Audio-Datei Verkehrslärm (oder Live-Inszenierung mit Soundeffekten)
- Warndreieck + Warnweste
- Verbandsmaterial (Druckverband-Demo)
- Notruf-Checkliste 5 W's (DIN A5, laminiert, 1/TN)
...
- Welche Information würdet ihr bei einem Kind als Patient zusätzlich geben?
...
- TN führen einen kompletten PAKET-Ablauf durch.
- TN erhalten die Eigenwärme eines Patienten mit Rettungsdecke + Wolldecke.

### Material
- Schauspielpatient (Rekrutierung! Vor UE bestätigen)
- Rettungsdecken, Wolldecken (Ziehharmonika-Falttechnik)
- Übungs-Dokumentationsbogen (DIVI-Standard, 1/TN)
- SAMPLER-Karte (DIN A5, 1/TN)
...
### Reflexionsfragen
- Wann würdet ihr die Anamnese abbrechen, weil der Patient instabil wird?
- Wie geht ihr mit Patienten um, die nicht oder kaum Deutsch sprechen?
...
- TN kommunizieren alters-, behinderungs- und kultursensibel.

### Material
- Rollenkarten (4: Kind 6 J., älterer Mensch 80 J., Person mit Sehbehinderung, Person mit Migrationshintergrund)
- Stoppuhr / Telefon
...
- **Authentizität:** Schauspielpatienten sollten nicht „übertreiben". Realistische, leise Hilflosigkeit ist wirksamer als dramatisches Weinen.
- **Raumklima:** Getrennte Ecken für die 4 Rollenspiele schaffen (Sichtschutz), damit Parallelität funktioniert.

### Reflexionsfragen
- Welche Kommunikations-Hürde würdet ihr im Einsatz am meisten fürchten?
- Wie würdet ihr euch fühlen, wenn ein Patient euch aus kulturellen Gründen nicht berühren lässt?
...
- TN führen eine strukturierte Übergabe an den Rettungsdienst durch.

### Material
- Übergabe-Checkliste (DIN A4, 1/TN, im Blockhefter)
- Übungs-Dokumentationsbogen (DIVI-Standard, 1/TN)
- Funkgerät oder Telefon für Übergabe-Simulation
- Reflexionsbogen „Was würdet ihr beim nächsten Mal anders machen?" (1/TN)
...
- Wie geht ihr mit einer Übergabe um, wenn der Notarzt genervt wirkt?
...
- **Stationen:** 1) Händedesinfektion unter UV-Licht, 2) ABCDE am Phantom, 3) Notruf am Telefon, 4) Übergabe
...
| Lerntyp | Anpassung |
|---|---|
| **Visuell** | Schaubilder, Demo-Videos, Farbcodierung (SAMPLER-Buchstaben) |
| **Auditiv** | Trainer-Demos, Audio-Hooks, Partnerdiskussion |
| **Kinästhetisch** | Praxis-Anteil 70 %, Hands-on-Übungen, Rollenspiele |
| **Lesen/Schreiben** | Blockhefter mit Zusammenfassungen, Reflexionsbögen |

| Bedarf | Anpassung |
|---|---|
| **Sprachbarrieren** | Schlüsselbegriffe auf Karteikarten, visuelle Kommunikation, langsam sprechen |
| **Erfahrene TN** (z. B. mit EH-Vorerfahrung) | Als Peer-Coach einsetzen, Bonusaufgaben (z. B. SAMPLER-Variante für komplexe Fälle) |
...
| Reanimations-Zertifikat (BLS) nicht älter als 12 Monate | für UE 2 + 3 |
| Erfahrung mit Schauspielpatienten | für UE 4 + 5 |
...
|---|---|
| TN hat Angst vor praktischen Übungen | Einfühlsames Vorgespräch, alternative Aufgabe |
...
### 17.4 Übergabe-Checkliste (DIN A4)
...
### 17.5 Blockhefter-Inhalt (1/TN, vor Blockbeginn)

1. Lernfeld-Übersicht + Lernziele (S. 12 Kommentar)
2. Hygiene-Schaubild
3. ABCDE-Schema-Karte
4. X-ABCDE-Erweiterung
5. SAMPLER-Karte
6. 5-W-Notruf-Karte
7. PAKET-Karte
8. 4-S-Regel-Karte
9. Eigenwärme-Anleitung (Ziehharmonika)
10. Übergabe-Checkliste
11. Dokumentationsbogen (DIVI)
